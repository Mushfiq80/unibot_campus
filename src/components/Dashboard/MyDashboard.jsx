        ...
        <div className='dashboard-content p-5 mx-5 rounded-md'>
            ...
            <div className='flex flex-col gap-8 sm:flex-row sm:gap-4'>
                <div className='flex items-center shadow-lg rounded-lg pr-4'>
                    <div className="stat pr-0 max-w-xs">
                        ...
                        <div className="stat-value flex items-center gap-10 font-semibold">7,890 <img src={miniGraph} alt="" /></div>
                    </div>   
                </div>
                <div className='w-full sm:w-3/4 p-2 text-xs rounded-md shadow-2xl'>
            ...
            <div className='my-10'>
                ...
                <div className='pl-10 py-2 rounded-md'>
                    ...
                    <span className='py-2 flex flex-col shadow-slate-800 sm:flex-row sm:items-center'>
                        <h3 className='w-full sm:w-1/4 font-semibold'>trungkienspktnd@gamail.com</h3>
                        <p className='w-full sm:w-3/4 sm:pl-4'>Streamlined interface greatly improved my chatting experience. Keep up the good work!</p>
                    </span>
                    <span className='py-2 flex flex-col sm:flex-row sm:items-center'>
                        <h3 className='w-full sm:w-1/4 font-semibold'>tranthuy.nute@gmail.com</h3>
                        <p className='w-full sm:w-3/4 sm:pl-4'>It simplifies university processes and provides timely assistance tailored to student needs.</p>
                    </span>
                    <span className='py-2 flex flex-col shadow-slate-800 sm:flex-row sm:items-center'>
                        <h3 className='w-full sm:w-1/4 font-semibold'>binhan628@gmail.com</h3>
                        <p className='w-full sm:w-3/4 sm:pl-4'>it efficiently addresses queries and offers relevant assistance, showcasing the creator's skills and dedication.</p>
                    </span>
                </div>
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <span className='flex items-center gap-4'>
                        ...
                        <details className="dropdown opacity-80">
                            ...
                            <ul className="p-2 shadow menu dropdown-content z-[1] bg-base-100 rounded-box w-52 hidden sm:block">
                                <li><a>Item 1</a></li>
                                <li><a>Item 2</a></li>
                            </ul>
                        </details>
